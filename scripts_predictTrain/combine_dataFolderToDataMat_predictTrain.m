...
%         length(nonzeros(dataMatTot))
    for j2 = 1:par.rmodes
%      
        saveName = sprintf('Data_predictTrain_dT%g_dP%g_xIn%g_yIn%g_sOn%g_STAw%g_STAs%g_NLDs%g_NLDg%g_wT%g',...
...
save(['results' filesep  'DataMatTot_predictTrain.mat'],'dataMatTot','sensorMatTot','varParList','varParList_short','par')
