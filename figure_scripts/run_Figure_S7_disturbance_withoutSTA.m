...
%% Data collection 
parameterSetName = 'S3C_phiDistnoSTA10';
load([ 'accuracyData' filesep 'parameterSet_' parameterSetName ])
fixPar.data_loc = 'accuracyData';
fixPar.nIterFig = 10;

[dataStruct,paramStruct]                    = combineDataMat( fixPar, simulation_menu.S3C_phiDistNoSTA  );
% [dataStructAllnoFilt,paramStructAllnoFilt]  = combineDataMat( fixPar, simulation_menu.S3C_all_nofilt );
