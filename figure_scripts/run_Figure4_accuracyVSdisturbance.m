...
parameterSetName = 'R2_stdevClass10';
...
print(fig2, ['figs' filesep 'Figure4_accuracyVSdisturbance' ], '-dpng', '-r600');
stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height*stupid_ratio];
set(fig2, 'PaperPosition', myfiguresize);
print(fig2, ['figs' filesep 'Figure4_accuracyVSdisturbance'], '-dsvg', '-r600');
