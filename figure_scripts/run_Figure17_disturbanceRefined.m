...
% parameterSetName = 'R1R4_Iter5_delay5_eNet09';
parameterSetName = 'S3_stdevClass10';
...
% Saving figure 
print(fig_S5, ['figs' filesep 'Figure17_disturbanceRefined' ], '-dpng', '-r600'); 

stupid_ratio = 15/16;
myfiguresize = [left, bottom, width*stupid_ratio, height*stupid_ratio];
set(fig_S5, 'PaperPosition', myfiguresize);
print(fig_S5, ['figs' filesep 'Figure17_disturbanceRefined'], '-dsvg', '-r600');
