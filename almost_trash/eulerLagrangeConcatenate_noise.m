function [ strainSet ] = eulerLagrangeConcatenate_noise(ph,th,par)
...
% define name for simdata with these parameters 
    simName = sprintf('strainSet_th%gph%git%2.0fcEl%2.0fsEl%2.0fEx%1.0fEy%1.0f.mat',...
        [th,ph,par.chordElements,par.curIter,par.spanElements,par.xInclude,par.yInclude]);
