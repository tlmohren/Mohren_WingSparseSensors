...
par.saveNameTest = 'CVXelasticNet_alpha09';
load(['results' filesep 'DataMatTot_',par.saveNameTest])
...
saveas(fig2,['figs' filesep 'Figure2A_ThetaDistVSPhiDist_' par.saveNameTest], 'png')
