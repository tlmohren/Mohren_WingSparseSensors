...
% par.saveNameTest 
% par.rmodes = 30;
par.saveNameTest = ['CVXelasticNet_alpha09']; par.CVXcase = 3; % equality
% par.rmodes = 40;
...
save(['results' filesep  'DataMatTot_',par.saveNameTest, '.mat'],'dataMatTot','sensorMatTot','varParList','varParList_short','par')
