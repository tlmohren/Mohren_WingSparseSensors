...
%      
        ...
        saveName = sprintf(['TestfilesCVX_norm11' par.saveNameTest '_dT%g_dP%g_xIn%g_yIn%g_sOn%g_STAw%g_STAs%g_NLDs%g_NLDg%g_wT%g'],...
...
save(['results' filesep  'DataMatTot_norm11.mat'],'dataMatTot','sensorMatTot','varParList','varParList_short','par')
