function [ strainSet ] = eulerLagrangeConcatenate_forfigures(ph,th,par)
...
%         strain_10 = eulerLagrange(10,ph,th ,par);
        [strain_0, figData0] = eulerLagrange_forfigures(0,ph,th ,par);
        [strain_10, figData10] = eulerLagrange_forfigures(10,ph,th ,par);
        strainSet.strain_0 = strain_0;
        strainSet.strain_10 = strain_10;
        strainSet.figData0= figData0;
        strainSet.figData10 = figData10;
